...
public class RuntimeExec
{
    ...
    private final static Logger log = Logger.getLogger(RuntimeExec.class.getName());
    ...
    public void setCommandMap(Map<String, String> commandsByOS)
    {
        ...
        log.info("The bean RuntimeExec property 'commandMap' has been deprecated;" +
    ...
    public void setProcessDirectory(String processDirectory)
    {
        ...
        else
        {
            ...
            {
                log.info("The runtime process directory is not visible when setting property 'processDirectory': \n" +
                        this);
            }
        }
    }
