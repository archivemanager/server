...
import org.archivemanager.util.DataTypeUtility;
...
public final class CharArrayBuffer implements Serializable {
    ...
    public String substringTrimmed(int beginIndex, int endIndex) {
        ...
        while (beginIndex < endIndex && DataTypeUtility.isWhitespace(this.buffer[beginIndex])) {
            beginIndex++;
        }
        while (endIndex > beginIndex && DataTypeUtility.isWhitespace(this.buffer[endIndex - 1])) {
            endIndex--;
        }
        return new String(this.buffer, beginIndex, endIndex - beginIndex);
    }
