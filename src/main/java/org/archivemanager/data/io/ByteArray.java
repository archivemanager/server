...
public class ByteArray extends InputStream {
	...
	public void appendLong(long value) {
		int newSize = size + 8;
		ensureCapacity(newSize);
		IOUtility.writeLong(array, value, size);
		size = newSize;
	}
	...
	public void appendInt(int value) {
		int newSize = size + 4;
		ensureCapacity(newSize);
		IOUtility.writeInt(array, value, size);
		size = newSize;
	}
	...
	public long getLong() {
		long ret = IOUtility.readLong(array, position);
		position += 8;
		return ret;
	}

	public int getInt() {
		int ret = IOUtility.readInt(array, position);
		position += 4;
		return ret;
	}
	...
	public void put(int index, int value) {
		IOUtility.writeInt(array, value, index);
	}

	public void put(int index, long value) {
		IOUtility.writeLong(array, value, index);
	}
	...
	public void put(int value) {
		...
		IOUtility.writeInt(array, value, position);
		position += 4;
	}
	...
	*/
	...
	public long[] getLongArray(int count) {
		...
		for (int i = 0; i < count; i++) {
			out[i] = IOUtility.readLong(array, position);
			position += 8;
 		}
		return out;
	}
	...
	public int[] getIntArray(int count) {
		...
		for (int i = 0; i < count; i++) {
			out[i] = IOUtility.readInt(array, position);
			position += 4;
 		}
		return out;
	}
	...
	public char[] getCharArray(int count) {
		...
		for (int i = 0; i < count; i++) {
			out[i] = IOUtility.readChar(array, position);
			position += 2;
 		}
		return out;
	}
